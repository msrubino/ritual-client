...
public class RageSplineAdapter : ScriptableObject, ISpline{
    ...
    public bool PinUvs {
        get { return _rageSpline.PinUvs; }
        set { _rageSpline.PinUvs = value; }
    }
    ...
    public bool Visible {
        get { return _rageSpline.Visible; }
        set { _rageSpline.Visible = value; }
    }
    ...
    private ISplinePoint InstantiateISplinePoint(int index) {
        var point = new RageSplinePointAdapter {Index = index, RageSpline = _rageSpline};
        return point;
    }
}
